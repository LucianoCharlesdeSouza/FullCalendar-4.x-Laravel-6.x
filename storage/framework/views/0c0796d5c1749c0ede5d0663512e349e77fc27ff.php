        ...
        <div id='external-events-list'>
            ...
            <?php if(isset($fastEvents)): ?>
                <?php $__empty_1 = true; $__currentLoopData = $fastEvents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fastEvent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div id="boxFastEvent<?php echo e($fastEvent->id); ?>"
...
<?php echo $__env->make('fullcalendar.template.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/app/resources/views/fullcalendar/views/calendar.blade.php ENDPATH**/ ?>